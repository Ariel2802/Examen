...
public class Journal implements Serializable {
    int journal_id;
    String portada, abbreviation, description, journalThumbnail, name;

    public Journal() {
    }

    public Journal(int journal_id, String portada, String abbreviation, String description, String journalThumbnail, String name) {
